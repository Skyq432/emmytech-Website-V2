...
insert into public.products (
  ...
  ('20000000-0000-4000-8000-000000000001','Demo Atlas 14 Laptop','demo-atlas-14','Fictional everyday laptop for local testing.',425000,'https://placehold.co/800x600?text=Demo+Atlas+14','laptops','10000000-0000-4000-8000-000000000001',12,'active',true,450000,6,425000,'Demo',now() - interval '1 day'),
  ('20000000-0000-4000-8000-000000000002','Test NovaBook Pro','test-novabook-pro','Fictional performance laptop for local testing.',785000,'https://placehold.co/800x600?text=Test+NovaBook+Pro','laptops','10000000-0000-4000-8000-000000000001',8,'active',true,820000,4,785000,'Test',now() - interval '2 days'),
  ('20000000-0000-4000-8000-000000000003','Demo Cedar Mini Laptop','demo-cedar-mini','Fictional compact laptop for local testing.',310000,'https://placehold.co/800x600?text=Demo+Cedar+Mini','laptops','10000000-0000-4000-8000-000000000001',15,'active',false,330000,6,310000,'Demo',now() - interval '3 days'),
  ('20000000-0000-4000-8000-000000000004','Test Orbit Phone X','test-orbit-phone-x','Fictional Android phone for local testing.',245000,'https://placehold.co/800x600?text=Test+Orbit+X','phones','10000000-0000-4000-8000-000000000002',20,'active',true,260000,6,245000,'Test',now() - interval '4 days'),
  ('20000000-0000-4000-8000-000000000005','Demo Lagoon Phone 5G','demo-lagoon-phone-5g','Fictional 5G phone for local testing.',198000,'https://placehold.co/800x600?text=Demo+Lagoon+5G','phones','10000000-0000-4000-8000-000000000002',18,'active',true,215000,8,198000,'Demo',now() - interval '5 days'),
  ('20000000-0000-4000-8000-000000000006','Test Palm Phone Lite','test-palm-phone-lite','Fictional entry phone for local testing.',98000,'https://placehold.co/800x600?text=Test+Palm+Lite','phones','10000000-0000-4000-8000-000000000002',30,'active',false,105000,7,98000,'Test',now() - interval '6 days'),
  ('20000000-0000-4000-8000-000000000007','Demo SunGrid 1kVA Kit','demo-sungrid-1kva','Fictional solar starter kit for local testing.',535000,'https://placehold.co/800x600?text=Demo+SunGrid+1kVA','solar','10000000-0000-4000-8000-000000000003',7,'active',true,565000,5,535000,'Demo',now() - interval '7 days'),
  ('20000000-0000-4000-8000-000000000008','Test RayVault Power Station','test-rayvault-power-station','Fictional portable power station.',285000,'https://placehold.co/800x600?text=Test+RayVault','solar','10000000-0000-4000-8000-000000000003',10,'active',true,300000,5,285000,'Test',now() - interval '8 days'),
  ('20000000-0000-4000-8000-000000000009','Demo BrightCell Panel','demo-brightcell-panel','Fictional 400W solar panel.',142000,'https://placehold.co/800x600?text=Demo+BrightCell','solar','10000000-0000-4000-8000-000000000003',24,'active',false,150000,5,142000,'Demo',now() - interval '9 days'),
  ('20000000-0000-4000-8000-000000000010','Test Echo Wireless Buds','test-echo-wireless-buds','Fictional wireless earbuds.',38000,'https://placehold.co/800x600?text=Test+Echo+Buds','accessories','10000000-0000-4000-8000-000000000004',40,'active',true,42000,10,38000,'Test',now() - interval '10 days'),
  ('20000000-0000-4000-8000-000000000011','Demo SwiftCharge 65W','demo-swiftcharge-65w','Fictional USB-C charger.',26500,'https://placehold.co/800x600?text=Demo+SwiftCharge','accessories','10000000-0000-4000-8000-000000000004',50,'active',false,30000,12,26500,'Demo',now() - interval '11 days'),
  ('20000000-0000-4000-8000-000000000012','Test Glide Wireless Mouse','test-glide-mouse','Fictional wireless mouse.',18500,'https://placehold.co/800x600?text=Test+Glide+Mouse','accessories','10000000-0000-4000-8000-000000000004',35,'active',false,20000,8,18500,'Test',now() - interval '12 days'),
  ('20000000-0000-4000-8000-000000000013','Demo CloudKey Keyboard','demo-cloudkey-keyboard','Fictional compact keyboard.',32000,'https://placehold.co/800x600?text=Demo+CloudKey','accessories','10000000-0000-4000-8000-000000000004',28,'active',false,35000,9,32000,'Demo',now() - interval '13 days'),
  ('20000000-0000-4000-8000-000000000014','Test Harbor USB Hub','test-harbor-usb-hub','Fictional seven-port USB hub.',22500,'https://placehold.co/800x600?text=Test+Harbor+Hub','accessories','10000000-0000-4000-8000-000000000004',32,'active',false,25000,10,22500,'Test',now() - interval '14 days'),
  ('20000000-0000-4000-8000-000000000015','Demo Shield Laptop Sleeve','demo-shield-sleeve','Fictional padded laptop sleeve.',16000,'https://placehold.co/800x600?text=Demo+Shield+Sleeve','accessories','10000000-0000-4000-8000-000000000004',45,'active',false,18000,11,16000,'Demo',now() - interval '15 days'),
  ('20000000-0000-4000-8000-000000000016','Test Beacon Smart Watch','test-beacon-watch','Fictional smart watch.',74000,'https://placehold.co/800x600?text=Test+Beacon+Watch','accessories','10000000-0000-4000-8000-000000000004',16,'active',false,80000,8,74000,'Test',now() - interval '16 days')
